...
Item.create(       
    ...
    {name: "Velvet Couch", description: "Used but in fairly good condition", price: 120, condition: "Used (normal wear)", image_url: "https://www.kfrooms.com/wp-content/uploads/2020/03/54905.jpg", category_id: sofas.id, user_id: paul.id},
    ...
    {name: "Gray Drusilla Tufted Upholstered Low Profile Standard Bed", description: "gray bed", price: 120, condition: "Other (see description)", image_url: "https://secure.img1-fg.wfcdn.com/im/00044277/compr-r85/1229/122980193/drusilla-tufted-upholstered-low-profile-standard-bed.jpg", category_id: bedroom.id, user_id: shalom.id},
    ...
    {name: "Gray Drusilla Tufted Upholstered Low Profile Standard Bed", description: "gray bed", price: 120, condition: "Used (normal wear)", image_url: "https://secure.img1-fg.wfcdn.com/im/00044277/compr-r85/1229/122980193/drusilla-tufted-upholstered-low-profile-standard-bed.jpg", category_id: bedroom.id, user_id: shalom.id},
