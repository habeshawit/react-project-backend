...
Item.create(       
    ...
    {name: "Green", description: "Couch in like new condition. Small dent in the back", price: 150, condition: "Open box (never used)", image_url: "https://images-na.ssl-images-amazon.com/images/I/81MUooSgfQL._AC_SL1500_.jpg", category_id: sofas.id, user_id: shalom.id},
