...
Item.create(       
    ...
    {name: "Gray Drusilla Tufted Upholstered Low Profile Standard Bed", description: "gray bed", price: 120, condition: "Other (see description)", image_url: "https://secure.img1-fg.wfcdn.com/im/00044277/compr-r85/1229/122980193/drusilla-tufted-upholstered-low-profile-standard-bed.jpg", category_id: couch.id, user_id: shalom.id},
